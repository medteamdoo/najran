...
class _TawasolFormPageState extends State<TawasolFormPage> {
  ...
  final companyConroller = TextEditingController();
  ...
  void initState() {
    ...
    if (currentUser != null) {
      ...
      companyConroller.text = currentUser.commercialCompany ?? "";
    }
  }
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              final company = companyConroller.text.trim();

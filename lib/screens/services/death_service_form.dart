                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          DropdownButtonFormField<RelativeModel>(
                            value: cubit.selectedRelative,
                            isExpanded: true,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(4),
                            ...
                            items: cubit.relatives.map((relative) {
                            ...
                            onChanged: (value) {
                              if (value != null) cubit.selectRelative(value);
                            },
                            validator: (value) => value == null
                                ? "الرجاء اختيار الصلة بالمتوفى"
                                : null,
                          ),
                          const SizedBox(height: 16),
                          LabeledField(
                            label: 'رقم جواز سفر المتوفى',
                            controller: deceasedPassportController,
                            required: true,
                          ),
                          const SizedBox(height: 16),
                          const Text(
                          ...
                          const SizedBox(height: 8),
                          _buildFilePickerButton("اختر ملف", "passport"),

                          const SizedBox(height: 16),
                          LabeledField(
                            label: 'رقم تأشيرة الدخول',
                          ...
                          const SizedBox(height: 8),
                          _buildFilePickerButton("اختر ملف", "residence"),
                          const SizedBox(height: 16),
                          Text(
                            "الدولة",
                            style: const TextStyle(
                          ...
                          Autocomplete<CountryModel>(
                            optionsBuilder: (TextEditingValue value) async {
                              ...
                              await cubit.fetchCountry(value.text);
                              return cubit.countries;
                            },
                            ...
                            fieldViewBuilder:
                                (context, controller, focusNode, onSubmit) {
                                  ...
                                  return TextFormField(
                                    ...
                                    validator: (_) {
                                      return cubit.selectedCountry == null
                                          ? "الرجاء اختيار الدولة من القائمة"
                                          : null;
                                    },
                                  );
                                },
                          ...
                          LabeledField(
                            label: 'عنوان ذويه في بلده',
                            controller: relativeAdressController,
                            required: true,
                          ),
                          const SizedBox(height: 16),
                          const Text(
                            "موافقة سفارة بلاده لترحيله *",
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                            ),
                          ...
                          const SizedBox(height: 8),
                          _buildFilePickerButton("اختر ملف", "embassy"),
                          ...
                          const SizedBox(height: 8),
                          _buildFilePickerButton("اختر ملف", "travel"),
                          ...
                          const SizedBox(height: 8),
                          _buildFilePickerButton("اختر ملف", "death"),
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                final data = {
                                  "relative_relation_id": cubit
                                      .selectedRelative!
                                      .id
                                      .toString(),
                                  "passport_number":
                                      deceasedPassportController.text,
                                  "visa_number": entryNumberController.text,
                                  "dead_ar_first": deceasedNameController.text,
                                  "dead_ar_family": "",
                                  "dead_ar_father": "",
                                  "dead_ar_grand": "",
                                  "country_id": cubit.selectedCountry!.id
                                      .toString(),
                                  ...
                                  "passport_attachment_ids": fileData(
                                    "passport",
                                  ),
                                  "residence_photo_attachment_ids": fileData(
                                    "residence",
                                  ),
                                  "embassy_approval_attachment_ids": fileData(
                                    "embassy",
                                  ),
                                  "trip_route_attachment_ids": fileData(
                                    "travel",
                                  ),
                                  "death_certificate_attachment_ids": fileData(
                                    "death",
                                  ),
                                ...
                                final success = await _apiService
                                    .sendFormulaire(
                                      context: context,
                                      endpoint: "/mobile/dead_transfer/request",
                                      data: data,
                                    );
